...
ActiveRecord::Schema.define(version: 20150630235045) do
  ...
  add_index "points", ["news_item_id"], name: "index_points_on_news_item_id", using: :btree
  ...
  add_foreign_key "points", "news_items"
